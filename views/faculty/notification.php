...
<head>
    ...
    <link rel="stylesheet" href="/library_system/assets/images/css/faculty/notification.css">
</head>
<body>
...
<div class="main-wrapper">
    ...
    <main class="page-content">
        ...
        <p class="text-muted mb-4">Stay updated with library news, material uploads, and system alerts.</p>
            ...
            <div class="notif-header">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/library_system/index.php?action=faculty_notifications&filter=all">All</a></li>
                        <li><a class="dropdown-item" href="/library_system/index.php?action=faculty_notifications&filter=unread">Unread</a></li>
                        <li><a class="dropdown-item" href="/library_system/index.php?action=faculty_notifications&filter=loans">Loans</a></li>
                        <li><a class="dropdown-item" href="/library_system/index.php?action=faculty_notifications&filter=system">System</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="notif-list-full">
                ...
                <?php else: ?>
                    <div class="notif-empty">
                        ...
                        <a href="/library_system/index.php?action=faculty_notifications" class="btn btn-sm btn-success rounded-pill px-4 mt-2">View All</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
